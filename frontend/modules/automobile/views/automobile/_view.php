			...
			<table style="width:100%;"><tr>
				<td style="text-align:left;">
					<?php if ( ! $model->isNewRecord): ?>
						<button delete_data_id="<?=$model->id?>" class="ajax-form-button-delete btn btn-danger" type="button" style="margin-right:20px;"><i class="glyphicon glyphicon-trash"></i> Delete</button>
					<?php endif; ?>
				</td>
				<td style="text-align:right;">
					<button data_id="<?=$model->id?>" class="btn btn-primary" type="button"><i class="glyphicon glyphicon-pencil"></i> Edit</button>
